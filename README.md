...
Jпределяется местоположение 
компас - не работает, из-за отсуствия его в эмуляторе.
акселерометр показывает ~9.8 - силя притяжения

<img width="305" height="542" alt="image" src="https://github.com/user-attachments/assets/b8486cc6-ca77-457e-a70c-7f4d1767ff92" />

Возникли проблемы с запуском приложения на мобильном устройстве
